...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'default-secret-key')  # Use environment variable for production secret key
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Add the URL of your frontend here for development
]
